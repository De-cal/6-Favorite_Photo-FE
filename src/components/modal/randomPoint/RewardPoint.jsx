...
import pointImage from "@/assets/images/img-point.webp";
      ...
      <div
        className={clsx(
          "relative flex flex-col items-center bg-gray-500 w-[345px] min-h-[441px]",
          {
            ...
            "h-[541px] sm:w-[455px] sm:h-[658px] md:w-[455px] md:h-[678px]":
              isSelected,
          },
        )}
      >
        ...
        {!isSelected ? (
          <div className="flex flex-col items-center">
            ...
            <div
              className={clsx("flex mt-12 gap-[15px] sm:gap-[25px] md:gap-15", {
