...
export default function MobileProfileModal() {
  ...
  return (
    <div onClick={handleMobileModalClose} className="fixed top-0 right-0 bottom-0 left-0 bg-transparent z-1 sm:hidden">
      <div className="fixed flex flex-col justify-between min-h-screen min-w-[260px] bg-gray-500 z-2">
        ...
        <div className="flex flex-col flex-1 justify-between items-start pt-[20px] px-[20px] pb-[40px]">
          <div className="flex flex-col justify-center items-start gap-[15px]">
            <Link onClick={handleMobileModalClose} href="/marketplace" className="font-bold text-[14px]/[17px]">
              마켓플레이스
            </Link>
            <Link onClick={handleMobileModalClose} href="/my-gallery" className="font-bold text-[14px]/[17px]">
              마이갤러리
            </Link>
            <Link onClick={handleMobileModalClose} href="/my-sell" className="font-bold text-[14px]/[17px]">
              판매 중인 포토카드
            </Link>
          </div>
          <Link
