...
import featImg1 from "@/assets/images/img-feat1.png";
  ...
  return (
    <div>
      <section className="bg-landing-feat1 flex flex-col justify-start w-full h-[440px] sm:h-[707px] md:h-[800px]">
        {/* 텍스트 */}
        <div className="flex flex-col items-start justify-center mt-[67px] ml-[32px] sm:mt-[110px] sm:ml-[61px] md:ml-[428px] w-full gap-3 sm:gap-[14px]">
