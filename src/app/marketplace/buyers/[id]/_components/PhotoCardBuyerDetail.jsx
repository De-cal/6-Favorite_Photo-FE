  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-start gap-y-[20px] sm:flex-row sm:gap-[20px] md:gap-[80px]">
        <div className="relative min-w-[345px] min-h-[258.75px] max-w-[960px] max-h-[720px] aspect-[345/258.75] mt-[26px] sm:w-full sm:mt-[48px] md:mt-[70px]">
          <Image
        ...
        <div className="sm:mt-[48px] md:mt-[70px]">
