    ...
    <>
      ...
      <div className="flex flex-col justify-center items-start gap-y-[20px] sm:flex-row sm:gap-[20px] md:gap-[80px]">
        <div className="relative w-[345px] min-h-[258.75px] max-w-[960px] max-h-[720px] aspect-[345/258.75] mt-[26px] sm:w-full sm:min-w-[342px] sm:mt-[48px] md:mt-[70px]">
          <Image src={cardArticle.photoCard.imgUrl} alt={cardArticle.photoCard.title} fill className="object-cover" />
        </div>
        <div className="max-w-[440px] sm:min-w-[342px] sm:mt-[48px] md:mt-[70px] w-full">
          <div className="flex justify-between items-center pb-[30px] border-b-[1px] border-gray-400">
            <div className="flex justify-center items-center gap-[10px] md:gap-[30px]">
              <GradeDetail grade={cardArticle.photoCard.rank} className="text-[18px]/[22px] md:text-[24px]/[29px]" />
            ...
            <p className="font-bold text-[18px]/[22px] underline">{cardArticle.user.nickname}</p>
          </div>
          ...
          <div className="flex flex-col py-[30px] gap-y-[10px] border-b-[1px] border-gray-400">
            <div className="flex justify-between items-center">
              <p className="font-normal text-[18px]/[22px] text-gray-300 md:text-[20px]/[24px]">가격</p>
              <p className="font-bold text-[20px]/[24px] md:text-[24px]/[29px]">{cardArticle.price} P</p>
            </div>
            <div className="flex justify-between items-center">
              <p className="font-normal text-[18px]/[22px] text-gray-300 md:text-[20px]/[24px]">잔여</p>
              <div className="flex justify-center items-center gap-[5px]">
                <p className="font-bold text-[20px]/[24px] md:text-[24px]/[29px]">{cardArticle.ramainingQuantity}</p>
