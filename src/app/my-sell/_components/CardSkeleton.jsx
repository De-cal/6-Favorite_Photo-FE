function CardSkeleton() {
  return (
    <div
      role="status"
      className="w-[170px] h-[234px] sm:w-[342px] sm:h-[500px] md:w-[440px] md:h-[600px] p-4 border border-gray-200 rounded-sm shadow-sm animate-custom-pulse md:p-6 dark:border-gray-800"
    >
      <div className="w-[135px] h-[85px] sm:w-[300px] sm:h-[210px] md:w-[390px] md:h-[240px] flex items-center justify-center  mb-3 bg-gray-300 rounded-sm px-auto mx-auto dark:bg-gray-800 sm:mb-6 md:mb-10 ">
        <svg
      ...
      <div className="h-2.5 sm:h-4.5 md:h-7 bg-gray-400 rounded-full dark:bg-gray-800 w-20 sm:w-30 md:w-45 mb-3 sm:mb-7 md:mb-10"></div>
      ...
      <div className="flex flex-row w-full items-center justify-center mt-2 sm:mt-8 md:mt-7">
        <p className="font-baskinRobbins text-[14px] sm:text-2xl text-white">
          최애
        </p>
        <p className="font-baskinRobbins text-[14px] sm:text-2xl text-main">
          의
        </p>
        <p className="font-baskinRobbins text-[14px] sm:text-2xl text-white">
          포토
